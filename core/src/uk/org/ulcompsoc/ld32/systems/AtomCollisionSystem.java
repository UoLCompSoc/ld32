...
public class AtomCollisionSystem  extends EntitySystem {
    ...
    public void update(float deltaTime) {
        ImmutableArray<Entity> towers = engine.getEntitiesFor(Family.all(Tower.class, Position.class,
                Renderable.class).get());

        List<Circle> towerBounds = new ArrayList<>();
        ...
        ImmutableArray<Entity> atoms = engine.getEntitiesFor(Family.all(Atom.class, Position.class,
                Renderable.class).get());

        List<Circle> atomBounds = new ArrayList<>();
