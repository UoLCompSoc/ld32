...
public abstract class Upgrade extends Component {
	...
	/*
	 * DAMAGE_PLUS(1.1f, 1.0f,1.0f,1.0f, 0, 1, false), SNIPER(1.2f, 0.8f, 1.0f,
	 * 1.0f, 0, 2, false), MORTAR(1.3f, 0.7f, 1.0f, 1.0f, 0, 3, false), // pure
	 * blue
	 * 
	 * BALL_DAMAGES_ENEMIES(1.15f, 0.9f, 1.0f, 1.0f, 1, 3, true),
	 * DOUBLE_SHOT(1.15f, 0.8f, 1.1f, 0.8f, 0, 3, true), BALL_EFFECT_PLUS(1.1f,
	 * 1.1f, 1.0f, 1.0f, 0, 3, true), ALL_IN_AOE(1.05f, 1.05f, 1.05f, 0.95f, 1,
	 * 3, true), BALLS_GIVE_DROPS_3(1.05f, 1f, 1f,1f, 1, 3, true),
	 * BALL_SPLITS(1f, 1.05f, 1.1f,0.90f, 1, 3, true), FIRE_DELAY(1.1f, 1f,
	 * 1.1f, 0.9f, 0, 3, true),
	 * 
	 * BALL_CHARGE(1.1f, 1.0f, 1.0f, 1.0f, 0, 2, true), QUICK_TOWER(1.1f, 1.4f,
	 * 1.0f, 1.0f, 0, 2, true), BALLS_GIVE_DROPS_2(1.0f, 1.0f, 1.2f, 0.8f, 0, 2,
	 * true),
	 * 
	 * 
	 ...
	 * MONSTER_DROPS_2(1.0f, 1.0f, 1.1f, 1.0f, 0, 2, false), UPGRADE_COSTS(1.0f,
	 * 1.0f, 1.0f, 0.9f, 0, 3, false), // pure green
	 * 
