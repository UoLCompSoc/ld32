...
public class Upgrade extends Component {
	...
	public static enum UpgradeType {
		DAMAGE_PLUS(1.1f, 1.0f,1.0f,1.0f, 1), 
		SNIPER(1.2f, 0.8f, 1.0f, 1.0f, 1),
		MORTAR(1.3f, 0.7f, 1.0f, 1.0f, 1), // pure blue
	...
	private void setUpgrade(UpgradeType upgradeType) {
		switch (upgradeType) {
			case DAMAGE_PLUS:
				this.dmgMultiplier = 1.1f; this.timeDelayFiringMultiplier = 1.0f; this.dropsMultiplier = 1.0f; this.costMultiplier = 1.0f;
			case SNIPER:
				this.dmgMultiplier = 1.2f; this.timeDelayFiringMultiplier = 0.8f; this.dropsMultiplier = 1.0f; this.costMultiplier = 1.0f;
			case MORTAR:
				this.dmgMultiplier = 1.3f; this.timeDelayFiringMultiplier = 0.7f; this.dropsMultiplier = 1.0f; this.costMultiplier = 1.0f;
			
			case BALL_NUMBER_PLUS_1:
				this.dmgMultiplier = 1.0f; this.timeDelayFiringMultiplier = 1.0f; this.dropsMultiplier = 1.0f; this.costMultiplier = 1.0f;
			case BALL_NUMBER_PLUS_2:
				this.dmgMultiplier = 1.0f; this.timeDelayFiringMultiplier = 1.0f; this.dropsMultiplier = 1.0f
		}
	}
}
