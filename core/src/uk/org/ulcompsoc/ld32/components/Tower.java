...
public class Tower extends Component {
	...
	private static final float DFLT_MONSTER_DROP_RATE = 0.1f; // not entirely sure what to make it equal - change if deemed necessary
	...
	public Tower(){
		...
		this.redBalls = 0; this.blueBalls = 0; this.greenBalls = 0;
